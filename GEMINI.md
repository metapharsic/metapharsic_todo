...
## Deployment Info
- **Production Server IP:** `187.127.169.217`
- **Application Path:** `/u01/apps/metapharsic_todo`
- **Database:** PostgreSQL (`metapharsic_todo_db` on port `5432`)
- **Process Manager:** PM2 (`ecosystem.config.js`)
- **Web Server:** Nginx (`metapharsic_todo_nginx.conf`)
...
- **Entry Points:**
  ...
  - `MetapharsicApp.jsx` -> Root sync file.
